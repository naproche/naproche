...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{definition}[Union]
      $A \cup B = \{ x "in" \Int \mid x \in A \vee x \in B \}$.
    \end{definition}

    \begin{definition}[Intersection]
      $A \cap B = \{ x "in" \Int \mid x \in A \wedge x \in B \}$.
    \end{definition}

    \begin{definition}[IntegerSets]
      A family of integer sets is a set $S$ such that for every element $x$ of $S$
        there is a set $s$ such that $s = x$ and $s$ is a subset of $\Int$.
    \end{definition}

    \begin{definition}
      Let $F$ be a family of integer sets.
      A member of $F$ is a set $s$ such that $s$ is an element of $F$.
    \end{definition}

    \begin{definition}[UnionSet]
      Let $S$ be a family of integer sets.
      $\bigcup S = \{ x "in" \Int \mid x "belongs to some member of" S \}$.
    \end{definition}
    ...
    \begin{definition}[Complement]
      $\overline{A} = \{ x "in" \Int \mid x "does not belong to" A \}$.
    \end{definition}
  ...
  \begin{forthel}
    \begin{definition}[ArSeq]
      $q \Int + a = \{ b "in" \Int \mid b is an integer and b = a ~(\mod q) \}$.
    \end{definition}
  ...
  \begin{forthel}
    \begin{definition}[Open]
      $A$ is open iff $A = \Int$ or for any integer $a$ such that $a$ is element of $A$ there exists $q$ such that $q \Int + a \subseteq A$.
    \end{definition}
  \end{forthel}
  ...
  \begin{forthel}
    ...
    \begin{definition}[OpenIntegerSets]
      An open family is a family of integer sets $S$ such that every member of $S$ is open.
    \end{definition}
  \end{forthel}
  ...
  \begin{forthel}
    ...
    \end{lemma}
    \begin{proof}
      Take an integer $x$ such that $x \in \bigcup S$.
      Take a set $M$ such that ($M$ is an element of $S$ and $x \in M$).
      Take $q$ such that $q \neq 0$ and $q \Int + x \subseteq M$. Then $q \Int + x \subseteq \bigcup S$.
    \end{proof}
    ...
    \begin{proof}
      ...
      Take an integer $x$ such that $x \in A \cap B$.
      ...
      Let us show that $p \cdot q$ is a nonzero integer and $(p \cdot q) \Int + x \subseteq A \cap B$.
        ...
        Take $a$ such that $a \in (p \cdot q) \Int + x$.
  ...
  \begin{forthel}
    \begin{axiom}[UnionSClosed]
      Let $S$ be a finite family of integer sets such that every member of $S$ are closed subsets of $\Int$. $\bigcup S$ is closed.
    \end{axiom}
  \end{forthel}
...
This characterization allows us to prove that a family $S$ of closed sets is infinite by assuming $S$ to be finite and deriving a contradiction from this assumption together with the statement that $\bigcup S$ is closed. In Fürstenberg's proof we will use this method to show that the family $\{ r \Int \mid r \text{ is prime} \}$ is infinite. To use the above argument we thus have to prove that any $r \Int$ -- or more general any $q \Int + a$ -- is closed.
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      Take an integer $b$ such that $b \in \overline{q \Int + a}$.

      Let us show that $q \Int + b \subseteq \overline{q \Int + a}$.
        Take an integer $c$ such that $c \in q \Int + b$.
        Case $c \in \overline{q \Int + a}$.
  ...
  \begin{forthel}
    \begin{theorem}[Fuerstenberg]
      Let $S$ be a set.
      Assume $S = \{ r \Int + 0 \mid r "is a prime" \}$.
      $S$ is infinite.
    \end{theorem}
    \begin{proof}
      ...
      Proof.
        Let us show that for any integer $n$ $n$ belongs to $\bigcup S$ iff $n$ has a prime divisor.
          ...
          Proof.
            Assume $n$ has a prime divisor. Take a prime divisor $p$ of $n$. $p \Int + 0 \in S$. $n \in p \Int + 0$.
          Qed.
