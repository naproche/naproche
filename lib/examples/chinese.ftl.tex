...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{definition}[DefSum]
      $X \oplus Y$ is a set such that for every element $z$ ($z \in X \oplus Y$) iff there exist
        an element $x$ of $X$ such that there exists an element $y$ of $Y$ such that $z = x + y$.
    \end{definition}
  ...
  \begin{forthel}
    ...
    \begin{definition}[DefIdeal]
      An ideal is a set $X$ such that for every element $x$ of $X$ we have
        $\forall y y \in X => (x + y \in X)$ and
