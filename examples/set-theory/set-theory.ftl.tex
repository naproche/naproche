...
\begin{document}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/01_functions.ftl.tex}
    \end{forthel}
  \end{comment}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/02_image-and-preimage.ftl.tex}
    \end{forthel}
  \end{comment}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/03_invertible-functions.ftl.tex}
    \end{forthel}
  \end{comment}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/04_functions-and-symmetric-difference.ftl.tex}
    \end{forthel}
  \end{comment}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/05_functions-and-set-systems.ftl.tex}
    \end{forthel}
  \end{comment}
  ...
  \begin{comment}
    \begin{forthel}
      \instruction{readtex set-theory/sections/02_functions/06_equipollency.ftl.tex}
    \end{forthel}
  \end{comment}
\end{document}
