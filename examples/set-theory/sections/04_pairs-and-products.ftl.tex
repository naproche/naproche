...
\begin{document}
  \chapter{Ordered pairs and Cartesian products}

  \readftl{set-theory/sections/04_pairs-and-products.ftl.tex}

  \begin{forthel}
    %[prove off][check off]

    [readtex \path{set-theory/sections/01_classes.ftl.tex}]
  ...
  \begin{forthel}
    \begin{axiom}\label{SET_THEORY_04_8464577431863296}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_04_4782386822774784}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_04_6746145623638016}
      Let $p$ be a pair.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_04_3750179243032576}
      Let $p$ be a pair.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_04_7971087096741888}
      Let $a, b$ be objects.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_04_7456594440749056}
