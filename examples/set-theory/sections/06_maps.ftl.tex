...
\begin{document}
  ...
  \readftl{set-theory/sections/06_maps.ftl.tex}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_4284980337311744}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_1938831225913344}
      Let $f$ be a map.
      The range of $f$ is
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_06_6386349418479616}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_7725375157174272}
      Let $B$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_2823507398361088}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_3390734908522496}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_06_3312973569327104}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_06_5104361690628096}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_06_6866147389472768}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_5135634870042624}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_06_3621991366000640}
      Let $f$ be a map such that $\dom(f) = A \times B$ for some nonempty classes $A, B$.
