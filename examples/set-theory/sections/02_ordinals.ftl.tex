...
\begin{document}
  ...
  \begin{forthel}
    ...
    Let $\alpha \less \beta$ stand for $\alpha$ is less than $\beta$.
    Let $\alpha \nless \beta$ stand for not $\alpha \less \beta$.

    Let $\alpha$ is greater than $\beta$ stand for $\beta \less \alpha$.
    Let $\alpha \gtr \beta$ stand for $\beta \less \alpha$.
    Let $\alpha \ngtr \beta$ stand for not $\alpha \gtr \beta$.
  \end{forthel}

  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_02_2639956210089984}
      Let $\alpha, \beta$ be ordinals.
      $\alpha$ is less than or equal to $\beta$ iff $\alpha \less \beta$ or
      $\alpha = \beta$.
    \end{definition}
  ...
  \begin{forthel}
    ...
    \begin{proof}
      Case $\alpha \leq \beta$.
        Then $\alpha \less \beta$ or $\alpha = \beta$.
        Let $x \in \alpha$.
        If $\alpha \less \beta$ then $x \in \alpha \in \beta$.
        Hence if $\alpha \less \beta$ then $x \in \beta$.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_7098683017396224}
      ...
      Then \[ (\text{$\alpha \less \beta$ and $\beta \less \gamma$}) \implies
      \alpha \less \gamma. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_1718825707896832}
      Let $\alpha, \beta$ be ordinals.
      Then $\alpha \less \beta$ or $\alpha = \beta$ or $\alpha \gtr \beta$.
    \end{proposition}
    \begin{proof}
      Assume the contrary.
      Define \[ A = \class{\alpha' \in \Ord | \classtext{there exists an ordinal
      $\beta'$ such that neither $\alpha' \less \beta'$ nor $\alpha' = \beta'$ nor
      $\alpha' \gtr \beta'$}}. \]
      $A$ is nonempty.
      Hence we can take a least element $\alpha'$ of $A$ regarding ${\in}$.
      Define \[ B = \{ \beta' \in \Ord \mid \text{neither $\alpha' \less \beta'$
      nor $\alpha' = \beta'$ nor $\alpha' \gtr \beta'$} \}. \]
      $B$ is nonempty.
      Hence we can take a least element $\beta'$ of $B$ regarding ${\in}$.

      Let us show that $\alpha' \subseteq \beta'$.
        Let $a \in \alpha'$.
        Then $a \less \beta'$ or $a = \beta'$ or $a \gtr \beta'$.
        Indeed if neither $a \less \beta'$ nor $a = \beta'$ nor $a \gtr \beta'$ then
        $a \in A$.
        If $a = \beta'$ then $\beta' \less \alpha'$.
        If $a \gtr \beta'$ then $\beta' \less \alpha'$.
        Hence $a \less \beta'$.
        Thus $a \in \beta'$.
      End.
      ...
      Let us show that $\beta' \subseteq \alpha'$.
        Let $b \in \beta'$.
        Then $b \less \alpha'$ or $b = \alpha'$ or $b \gtr \alpha'$.
        If $b = \alpha'$ then $\alpha' \less \beta'$.
        If $b \gtr \alpha'$ then $\alpha' \less \beta'$.
        Hence $b \less \alpha'$.
        Thus $b \in \alpha'$.
      End.
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      Case $\alpha \neq \beta$.
        Then $\alpha \less \beta$ or $\alpha \gtr \beta$.
        Assume $\alpha \gtr \beta$.
        Then $\beta \in \alpha$.
        Hence $\beta \in \beta$.
        Contradiction.
      End.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_8242798790705152}
      ...
      $\alpha \less \beta \less \succ{\alpha}$.
    \end{proposition}
    \begin{proof}
      Assume the contrary.
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      If $\succ{\alpha} \notin \lambda$ then $\alpha \less \lambda \less \succ{\alpha}$.
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{theorem}[Burali-Forti Paradox]\printlabel{SET_THEORY_03_2217148434874368}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_02_4059354166722560}
      \[ \LessRel = \{ (\alpha, \beta) \mid \text{$\alpha$ and $\beta$ are ordinals
      such that $\alpha \less \beta$} \}. \]
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_4859038791630848}
      $\LessRel$ is a strong wellorder on $\Ord$.
    \end{proposition}
    \begin{proof}
      For any ordinals $\alpha, \beta$ we have $(\alpha,\beta) \in \LessRel$ iff
      $\alpha \less \beta$.

      (1) $\LessRel$ is irreflexive on $\Ord$.
      Indeed for any ordinal $\alpha$ we have $\alpha \nless \alpha$.

      (2) $\LessRel$ is transitive on $\Ord$.
      Indeed for any ordinals $\alpha, \beta, \gamma$ if $\alpha \less \beta$ and
      $\beta \less \gamma$ then $\alpha \less \gamma$.

      (3) $\LessRel$ is connected on $\Ord$.
      Indeed for any distinct ordinals $\alpha, \beta$ we have $\alpha \less \beta$
      or $\beta \less \alpha$.

      Hence $\LessRel$ is a strict linear order on $\Ord$.

      (4) $\LessRel$ is wellfounded on $\Ord$. \\
      Proof.
        Let $A$ be a nonempty subclass of $\Ord$.
        Then we can take a least element $\alpha$ of $A$ regarding ${\in}$.
        Then $\alpha$ is a least element of $A$ regarding $\LessRel$.
      Qed.

      Hence $\LessRel$ is strongly wellfounded on $\Ord$.
      Indeed for any $\beta \in \Ord$ we have $\beta = \{ \alpha \in \Ord \mid
      (\alpha,\beta) \in \LessRel \}$.
      Thus $\LessRel$ is a strong wellorder on $\Ord$.
    \end{proof}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{SET_THEORY_02_1042046129274880}
      ...
      If $A$ is nonempty then $A$ has a least element regarding $\LessRel$.
    \end{corollary}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_03_8114657499807744}
      $\LessRel$ is a strong wellorder on any ordinal.
    \end{proposition}
    \begin{proof}
      Let $\alpha$ be an ordinal.
      For all $\beta, \gamma \in \alpha$ we have $(\beta,\gamma) \in \LessRel$ iff
      $\beta \less \gamma$.

      (1) $\LessRel$ is irreflexive on $\alpha$.
      Indeed for all $\beta \in \alpha$ we have $\alpha \nless \alpha$.

      (2) $\LessRel$ is transitive on $\alpha$.
      Indeed for all $\beta, \gamma, \delta \in \alpha$ if $\beta \less \gamma$ and
      $\gamma \less \delta$ then $\beta \less \delta$.

      (3) $\LessRel$ is connected on $\alpha$.
      Indeed for any distinct $\beta, \gamma \in \alpha$ we have
      $\beta \less \gamma$ or $\gamma \less \beta$.

      Hence $\LessRel$ is a strict linear order on $\alpha$.

      (4) $\LessRel$ is wellfounded on $\alpha$. \\
      Proof.
        Let $A$ be a nonempty subclass of $\alpha$.
        Then we can take a least element $\beta$ of $A$ regarding $\LessRel$.
        Indeed $A$ is a subclass of $\Ord$.
      Qed.

      Hence $\LessRel$ is strongly wellfounded on $\alpha$.
      Indeed for any $\gamma \in \alpha$ we have
      $\gamma = \{ \beta \in \Ord \mid (\beta,\gamma) \in \LessRel \}$.
      Thus $\LessRel$ is a strong wellorder on $\alpha$.
      [unfold off]
    \end{proof}
  \end{forthel}
