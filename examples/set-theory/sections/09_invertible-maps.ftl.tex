...
\begin{document}
  \chapter{Invertible maps and involutions}

  \readftl{set-theory/sections/09_invertible-maps.ftl.tex}

  \begin{forthel}
    %[prove off][check off]

    [readtex \path{set-theory/sections/08_injections-surjections-bijections.ftl.tex}]
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_09_7776974319648768}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_09_3430350086733824}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{lemma}\label{SET_THEORY_09_5108611793551360}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_09_6458627204317184}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_7840743571849216}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_8414736098000896}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_4577560740495360}
      Let $A, B$ be classes and $f : A \onto B$.
      Assume that $f$ is invertible.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_4606651604664320}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_7619151963095040}
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_09_5708971514003456}
      Let $A, B$ be classes and $f : A \onto B$.
      Assume that $f$ is invertible.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_09_7282039688527872}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_7944474185433088}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_6897019612299264}
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_09_5958206868160512}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_09_2314262743613440}
