...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_14_8167915266244608}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_6964770955591680}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_14_4219967964708864}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_2095807333400576}
      Every transitive class is a system of sets.
    \end{proposition}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_6524117649981440}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_620651482185728}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_6726468811882496}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_4884401668227072}
      Let $X$ be a system of transitive sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_1399002962591744}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_14_6995689103949824}
      Let $A$ be a transitive class.
