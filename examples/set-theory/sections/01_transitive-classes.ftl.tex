...
\begin{document}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_14_620651482185728}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_14_6726468811882496}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_14_4884401668227072}
      Let $X$ be a system of transitive sets.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_14_1399002962591744}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_14_6995689103949824}
      Let $A$ be a transitive class.
