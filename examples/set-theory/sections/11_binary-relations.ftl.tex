...
\begin{document}
  ...
  \readftl{set-theory/sections/11_binary-relations.ftl.tex}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_6429308924985344}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_1126092393938944}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_365656446861312}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_2056300137545728}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_8301693043212288}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_6895428727472128}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_5377309666181120}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_5902056743239680}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_6492592562765824}
      Let $R$ be a binary relation and $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_4005024520732672}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_2162776243961856}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_4067384857985024}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_11_5567849812721664}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_5872706501214208}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_5840248768561152}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_2729326472593408}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_2420057567133696}
      Let $A$ be a class and $R$ be a binary relation.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_3262141912055808}
      Let $A$ be a class and $R$ be a binary relation.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_6149137814781952}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_8163723743068160}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_11_4800525813940224}
      \[ {\in} = \class{(a,x) | \text{$x$ is a set that contains $a$}}. \]
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_11_5668859243659264}
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_11_6337807438053376}
      Let $X$ be a system of sets.
      If $X$ is nonempty then $X$ has a least element regarding ${\in}$.
    \end{corollary}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_11_2812087589928960}
      Let $\Phi$ be a class.
