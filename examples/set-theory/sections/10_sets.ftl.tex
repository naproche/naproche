...
\begin{document}
  ...
  \readftl{set-theory/sections/10_sets.ftl.tex}

  \begin{forthel}
    %[prove off][check off]

    [readtex \path{set-theory/sections/09_invertible-maps.ftl.tex}]
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_5530582838673408}
      A proper class is a class that is not a set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_1346889551183872}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_1448589907722240}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_5805323570905088}
      A system of sets is a class $X$ such that every element of $X$ is a set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_1631952387964928}
      A system of nonempty sets is a class $X$ such that every element of $X$ is a nonempty set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_943381479948288}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_8268633648136192}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_7546016869908480}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_541772562300928}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_4872701241982976}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_2559541585641472}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_10_2157223832715264}
      Let $x$ be a set.
      Then \[ \bigcup \set{x} = x. \]
    \end{corollary}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_10_2659345095458816}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_2809770322952192}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_7851827447988224}
      Let $x, y$ be sets.
    ...
    \begin{proof}
      ...
      Let us show that $x \cap y = \bigcap \set{x, y}$.
        Let $a \in x \cap y$.
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_10_7239895674257408}
      Let $x$ be a set.
      Then \[ \bigcap \set{x} = x. \]
    \end{corollary}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{axiom}[Set existence]\label{SET_THEORY_10_2362039748001792}
      There exists a set.
    \end{axiom}
  \end{forthel}

  \begin{forthel}
    \begin{axiom}[Separation]\label{SET_THEORY_10_2263707272871936}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{axiom}[Pairing]\label{SET_THEORY_10_7376893816864768}
      Let $a, b$ be objects.
  ...
  \begin{forthel}
    \begin{axiom}[Union]\label{SET_THEORY_10_5536459412996096}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{axiom}[Infinity]\label{SET_THEORY_10_367388832825344}
      Let $A$ be a class and $a \in A$ and $f : A \to A$.
      Then there exists a subset $X$ of $A$ such that $a \in X$ and for all
      $x \in X$ we have $f(x) \in X$.
    \end{axiom}
  \end{forthel}

  \begin{forthel}
    \begin{axiom}[Powerset]\label{SET_THEORY_10_5862230203564032}
      Let $x$ be a set.
      Then $\pow(x)$ is a set.
    \end{axiom}
  ...
  \begin{forthel}
    \begin{axiom}[Choice]\label{SET_THEORY_10_1897613305577472}
  ...
  \begin{forthel}
    \begin{axiom}[Foundation]\label{SET_THEORY_10_1320008569323520}
  ...
  \begin{forthel}
    \begin{axiom}[Replacement]\label{SET_THEORY_10_8142956584239104}
  ...
  \begin{forthel}
    \begin{axiom}[Function]\label{SET_THEORY_10_7781693549182976}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_5891530432708608}
      $\emptyset$ is a set.
    \end{proposition}
    \begin{proof}
      Take a set $x$ (by \ref{SET_THEORY_10_2362039748001792}).
      Define $A = \class{y \in x | y \neq y}$.
      Then $A$ is a set (by \ref{SET_THEORY_10_2263707272871936}).
      We have $A = \emptyset$.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_4052198354845696}
      Let $x, y$ be sets.
    ...
    \begin{proof}
      ...
      $\bigcup X$ is a set (by \ref{SET_THEORY_10_5536459412996096}).
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_4475839687163904}
      Let $x, y$ be sets.
      Then $x \cap y$ is a set.
    \end{proposition}
    \begin{proof}
      We have $x \cap y \subseteq x$.
      Hence $x \cap y$ is a set (by \ref{SET_THEORY_10_2263707272871936}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_7795203882614784}
      Let $x, y$ be sets.
      Then $x \setminus y$ is a set.
    \end{proposition}
    \begin{proof}
      We have $x \setminus y \subseteq x$.
      Hence $x \setminus y$ is a set (by \ref{SET_THEORY_10_2263707272871936}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_4458706448154624}
      Let $x, y$ be sets.
    ...
    \begin{proof}
      ...
      Proof.
        ...
        \ref{SET_THEORY_10_5862230203564032}).
        Therefore $P$ is a set (by \ref{SET_THEORY_10_2263707272871936}).
      Qed.

      Define $l(p) = \text{choose $a \in x$, choose $b \in y$ such that
      $p = \set{\set{a}, \set{a,b}}$ in $a$}$ for $p \in P$.
      Define $r(p) = \text{choose $a \in x$, choose $b \in y$ such that
      ...
      Proof.
        ...
        For any $a \in x$ and any $b \in y$ we have $(a,b) =
        f(\set{\set{a}, \set{a,b}})$.
        Thus $(a,b) \in f[P]$ for all $a \in x$ and all $b \in y$.

        Consequently $x \times y = f[P]$.
      Qed.

      Thus $x \times y$ is the image of some set under some map.
      Therefore $x \times y$ is a set (by \ref{SET_THEORY_10_8142956584239104}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_5486815207227392}
      Let $X$ be a nonempty system of sets.
    ...
    \begin{proof}
      ...
      Hence $\bigcap X$ is a set (by \ref{SET_THEORY_10_2263707272871936}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_7598384349184000}
      Let $f$ be a map such that $\dom(f)$ is a set.
      Then $\range(f)$ is a set.
    \end{proposition}
    \begin{proof}
      $\range(f) = f_{*}(\dom(f))$ and $f_{*}(\dom(f))$ is a set.
      Hence $\range(f)$ is a set (by \ref{SET_THEORY_10_8142956584239104}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_8631339572002816}
    ...
    \begin{proof}
      ...
      Thus $A$ is a set (by \ref{SET_THEORY_10_8142956584239104}).
    \end{proof}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_10_8812282138066944}
    ...
    \begin{proof}
      ...
      disjoint (by \ref{SET_THEORY_10_1320008569323520}).
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_10_3086917813927936}
      Let $x$ be a set.
      Then $x \notin x$.
    \end{corollary}
  \end{forthel}
