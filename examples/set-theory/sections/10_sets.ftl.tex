...
\begin{document}
  ...
  \begin{forthel}
    ...
    [readtex \path{set-theory/sections/04_pairs-and-products.ftl.tex}]
  ...
  \begin{forthel}
    \begin{axiom}[Infinity]\label{SET_THEORY_10_367388832825344}
      There exists a set $x$ such that $\emptyset \in x$ and for all sets $y$ if
      $y \in x$ then $y \cup \set{y} \in x$.
    \end{axiom}
  \end{forthel}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Take a set $x$ (by \ref{SET_THEORY_10_367388832825344}).
