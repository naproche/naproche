...
\begin{document}
  ...
  \readftl{set-theory/sections/08_injections-surjections-bijections.ftl.tex}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_08_605931408719872}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_08_7264375979114496}
      Let $B$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_08_5754157419986944}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_08_3356670992318464}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_08_60881194975232}
