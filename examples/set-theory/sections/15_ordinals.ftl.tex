...
\begin{document}
  ...
  \readftl{set-theory/sections/15_ordinals.ftl.tex}

  \begin{forthel}
    %[prove off][check off]

    [readtex \path{set-theory/sections/11_binary-relations.ftl.tex}]

    [readtex \path{set-theory/sections/14_transitive-classes.ftl.tex}]
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_1624410224066560}
      Let $\alpha$ be an ordinal.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_8651096763400192}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_6229364135952384}
      Let $\alpha$ be an ordinal.
      Then \[ \alpha \nless \alpha. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_7098683017396224}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_1718825707896832}
      Let $\alpha, \beta$ be ordinals.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_610496856195072}
      Let $\alpha, \beta$ be ordinals.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_5689190964527104}
      Let $\alpha$ be an ordinal.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_4064972025888768}
      Let $\alpha, \beta$ be ordinals.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_15_8242798790705152}
      Let $\alpha$ be an ordinal.
