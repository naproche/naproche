...
\begin{document}
  \chapter{Computation laws for Cartesian products}

  \readftl{set-theory/sections/05_computation-laws-for-products.ftl.tex}

  \begin{forthel}
    %[prove off][check off]

    [readtex \path{set-theory/sections/02_computation-laws-for-classes.ftl.tex}]
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_5719644021194752}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_4888282951319552}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_8849658323402752}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_476526841692160}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_1249567930580992}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_954964241285120}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_6495329908162560}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_3195639422779392}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_2677218429894656}
      Let $A, A', B, B'$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_4154592050806784}
      Let $A, A', B, B'$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_05_7090174334861312}
      Let $A, A', B, B'$ be classes.
