...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}
      A partition of $x$ is a system of sets $P$ such that every element of $x$ is contained in some set of $P$ and every member of $P$ is a nonempty subset of $x$ and for any set $A,B$ of $P$ we have $A \cap B = \emptyset$.
    \end{definition}
