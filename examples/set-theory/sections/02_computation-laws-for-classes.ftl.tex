...
\begin{document}
  \chapter{Computation laws for classes}

  \readftl{set-theory/sections/02_computation-laws-for-classes.ftl.tex}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_02_8446177632583680}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_02_7565102251245568}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_02_371139087958016}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_02_5937390721957888}
      Let $A, B, C$ be classes.
