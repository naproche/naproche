...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{lemma}[L4o5]
      Assume $x-y-z$ and $x-z : r-w$. Then there exists $v$ such that ($r-v-w$ and $\SenaryCong{x}{y}{z}{r}{v}{w}$).
    \end{lemma}
    \begin{proof}
    ...
    \begin{lemma}[L4o6]
      Assume $x-y-z$ and $\SenaryCong{x}{y}{z}{r}{v}{w}$. Then $r-v-w$.
    \end{lemma}
    \begin{proof}
      Take $u$ such that $r-u-w$ and $\SenaryCong{x}{y}{z}{r}{u}{w}$.
    ...
    \begin{axiom}[L4o14]
      Assume $\Col{x}{y}{z}$ and $x-y : r-v$. Then there exists $w$ such that $\SenaryCong{x}{y}{z}{r}{v}{w}$.
    \end{axiom}

    \begin{definition}[L4o15]
      $FS(x,y,z,r,v,w,p,q)$ iff $\Col{x}{y}{z}$ and $\SenaryCong{x}{y}{z}{v}{w}{p}$ and $x-r : v-q$ and $y-r : w-q$.
    \end{definition}
