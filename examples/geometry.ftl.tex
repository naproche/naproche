...
\documentclass[10pt,a4paper,parskip=half,numbers=endperiod,headings=standardclasses,parskip]{scrbook}
...
\begin{document}
  ...
  \begin{forthel}
    \begin{lemma} %[C5o1f]
      Assume $x \neq y$ and $x-y-z$ and $x-y-r$. Then there exist points
      $\fresha,\freshb$ such that $x-r-\fresha$ and $r-\fresha : z-r$ and $x-z-\freshb$ and $z-\freshb : z-r$.
    \end{lemma}
    \begin{proof}
  ...
  \begin{forthel}
    ...
    %	Then $\BetwFive{x}{y}{z}{q}{t}$ and $\BetwFive{x}{y}{r}{p}{s}$.
    %	Then $y-p : t-z$.
    %	Then $y-t : t-y$.
    %	Then $s = t$.
    ...
    \begin{axiom}(Gupta) % Satz 5.1 (TODO)
      Assume $a \neq b$.
  ...
  \end{forthel}
    ...
    \begin{proof}
      Take $\cprime,\dprime$ such that
      $\Betw{a}{d}{\cprime}$ and $\Cong{d}{\cprime}{c}{d}$ and
      $\Betw{a}{c}{\dprime}$ and $\Cong{c}{\dprime}{c}{d}$.
      Then $c = \cprime$ or $d = \dprime$. % (by C5o1p).
      Proof.
        Take points $\bprime,\bdoubleprime$ such that
          $\Betw{c}{\dprime}{\bdoubleprime}$ and $\Betw{d}{\cprime}{\bprime}$.
        % Then $Th(a,b,c,d,\cprime,\dprime,\bprime,\bdoubleprime)$.
        Then
          $\BetwFive{a}{b}{c}{\dprime}{\bdoubleprime}$ and
          $\BetwFive{a}{b}{d}{\cprime}{\bprime}$.
      End.
