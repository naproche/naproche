...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}[OFS]
      $\OFS{x}{y}{z}{r}{u}{v}{w}{p}$ iff
      $\Betw{x}{y}{z}$ and $\Betw{u}{v}{w}$ and $\Cong{x}{y}{u}{v}$
      and $\Cong{y}{z}{v}{w}$ and $\Cong{x}{r}{u}{p}$ and $\Cong{y}{r}{v}{p}$.
    \end{definition}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{lemma} % Satz 2.12
      Assume $q \neq x$.
      Suppose $\Betw{q}{x}{y}$ and $\Cong{x}{y}{v}{w}$.
      Suppose $\Betw{q}{x}{z}$ and $\Cong{x}{z}{v}{w}$.
      Then $y = z$.
    \end{lemma}
    \begin{proof}
