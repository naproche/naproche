...
\begin{document}
  ...
  \begin{forthel}
    \begin{lemma}[L2o11]
      Assume $x-y-z$ and $r-v-w$ and $x-y : r-v$ and $y-z : v-w$.
      Then $x-z : r-w$.
    \end{lemma}
    \begin{proof}
      $\OFS{x}{y}{z}{x}{r}{v}{w}{r}$.         % By previous results and assumption.
      Assume $x = y$. Then $r = v$.   % Axiom A3 gives this implication.
      Assume $x \neq y$.              % Axiom A5 completes the proof.
    \end{proof}
    % The following proof follows the proof from \textit{SST} and works, but can be
    % omitted entirely.
  \end{forthel}
  ...
  \begin{forthel}
    \begin{lemma}[L2o12]
      Assume $q \neq x$.
      Suppose $q-x-y$ and $x-y : v-w$ and $q-x-r$ and $x-r : v-w$.
      Then $y = r$.
    \end{lemma}
  \end{forthel}
