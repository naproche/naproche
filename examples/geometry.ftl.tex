...
\begin{document}
  ...
  \chapter{Connexity of betweenness}
  ...
  \begin{forthel}
    ...
    %\begin{lemma} %[C5o1n]
    %  Assume $Th2(x,y,z,r,p,q,g)$ and $\OFS{y}{z}{q}{p}{g}{p}{r}{z}$ and $p-q : z-r$.
    %  Then there exist $u$ such that $z-u-p$ and $r-u-q$.
    %\end{lemma}
  ...
  \begin{forthel}
    ...
    \begin{lemma}[Gupta] % Satz 5.1 (TODO)
      Assume $a \neq b$.
    ...
    \begin{proof}
      ...
      Proof.
        ...
        %
        % TODO: use Satz 2.11
        %We have $\Cong{b}{\bdoubleprime}{\bdoubleprime}{b}$.
