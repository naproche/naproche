...
\begin{document}
  ...
  \begin{forthel}
    \begin{axiom}\printlabel{SET_THEORY_04_8464577431863296}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_04_4782386822774784}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_04_6746145623638016}
      Let $p$ be a pair.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_04_3750179243032576}
      Let $p$ be a pair.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_04_2877806274936832}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_04_1581118511906816}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_04_2198552029691904}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_04_7971087096741888}
      Let $a, b$ be objects.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_04_7456594440749056}
