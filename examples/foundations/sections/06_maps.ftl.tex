...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_4284980337311744}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_1938831225913344}
      Let $f$ be a map.
      The range of $f$ is
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_6386349418479616}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_1920902360989696}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_7605717729017856}
      Let $f, g$ be maps.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_7095412741636096}
      Let $f$ be a map and $X \subseteq \dom(f)$.
      %$f \restriction_{X}$ is the map defined on $X$ such that $(f \restriction_{X})(a) = f(a)$ for all $a \in X$.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_2170189258948608}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_3038237683613696}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_4563167805964288}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_6934038600220672}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_7725375157174272}
      Let $B$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_2823507398361088}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_3390734908522496}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_3312973569327104}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_5104361690628096}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_1706446651654144}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_4078561256275968}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_3964401904254976}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_3118771061391360}
      Let $A$ be a class and $X \subseteq A$.
      Then \[ \id_{A} \restriction_{X} = \id_{X}. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_6866147389472768}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_5135634870042624}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_06_3621991366000640}
      Let $f$ be a map such that $\dom(f) = A \times B$ for some nonempty classes $A, B$.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_8946256734846976}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_8080207992848384}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_2754759509409792}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_06_2304295212941312}
