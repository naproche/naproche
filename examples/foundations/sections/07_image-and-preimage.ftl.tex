...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      We have $g_{*}(f_{*}(X)) = \class{ g(b) | \text{$b \in f_{*}(X)$} }$ and
      $f_{*}(X) = \class{ f(a) | a \in X }$.
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      We have $g^{*}(Z) = \class{ b \in B | g(b) \in Z }$ and
      $f^{*}(g^{*}(Z)) = \class{ a \in A | f(a) \in g^{*}(Z) }$.
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Let us show that $f^{*}(Y \setminus Y') \subseteq
      f^{*}(Y) \setminus f^{*}(Y')$.
      ...
      Let us show that $f^{*}(Y) \setminus f^{*}(Y') \subseteq
      f^{*}(Y \setminus Y')$.
