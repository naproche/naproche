...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_13_4578620297183232}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_13_3703161885818880}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_13_8050301789536256}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_13_3609912414306304}
  ...
  \begin{forthel}
    \begin{theorem}[Cantor-Schröder-Bernstein]\printlabel{SET_THEORY_13_1913663275401216}
      Let $x, y$ be sets.
