...
\begin{document}
  \chapter{Computation laws for classes}\label{computation-laws-for-classes}

  \readftl{foundations/sections/02_computation-laws-for-classes.ftl.tex}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_8446177632583680}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_7565102251245568}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_3854032263184384}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_906751977193472}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_371139087958016}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_5937390721957888}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_2096996737351680}
      Let $A$ be a class.
      Then \[ A \cup A = A. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_4053144145231872}
      Let $A$ be a class.
      Then \[ A \cap A = A. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_5296031436636160}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_2909554153095168}
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_3793981508943872}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_1591517646946304}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_6657236858306560}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_2356449346846720}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_7433299337150464}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_3783696985358336}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_7083929257377792}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_4938646769631232}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_02_5811954316738560}
      Let $A, B, C$ be classes.
