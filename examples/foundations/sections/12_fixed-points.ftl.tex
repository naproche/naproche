...
\begin{document}
  ...
  \readftl{foundations/sections/12_fixed-points.ftl.tex}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_12_2177076576649216}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_12_1394550966845440}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_12_3290499861446656}
  ...
  \begin{forthel}
    \begin{theorem}[Knaster-Tarski]\printlabel{SET_THEORY_12_8420450166112256}
      Let $x$ be a set.
