...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_3275578358628352}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_5994555614691328}
      Let $A$ be a class.
      Then \[ A \subseteq A. \]
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_3939677545431040}
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_7159957847801856}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_6252477624090624}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_7939928493129728}
      \[ \emptyset = \class{ x | x \neq x }. \]
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_2263153161273344}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_01_1495141426659328}
      $\emptyset$ is empty.
    \end{corollary}
  \end{forthel}

  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_01_6931785090859008}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_3471035364016128}
      Let $a, b$ be objects.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_1160414603771904}
      Let $a$ be an object.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_6125259604361216}
  ...
  \begin{forthel}
    \begin{corollary}\label{SET_THEORY_01_6954678910713856}
      Let $a, a'$ be objects.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_2159753924968448}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_5744033011859456}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_7620345041256448}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{definition}\label{SET_THEORY_01_4981913324355584}
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}\label{SET_THEORY_01_1211191546347520}
      Let $A, B$ be classes.
