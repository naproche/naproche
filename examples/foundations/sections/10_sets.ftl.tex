...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_5530582838673408}
      A proper class is a class that is not a set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_1346889551183872}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_1448589907722240}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_5805323570905088}
      A system of sets is a class $X$ such that every element of $X$ is a set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_1631952387964928}
      A system of nonempty sets is a class $X$ such that every element of $X$ is a nonempty set.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_943381479948288}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_8268633648136192}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_7546016869908480}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_541772562300928}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_4872701241982976}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_2559541585641472}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{SET_THEORY_10_2157223832715264}
      Let $x$ be a set.
      Then \[ \bigcup \set{x} = x. \]
    \end{corollary}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{definition}\printlabel{SET_THEORY_10_2659345095458816}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_2809770322952192}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_7851827447988224}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{SET_THEORY_10_7239895674257408}
      Let $x$ be a set.
      Then \[ \bigcap \set{x} = x. \]
    \end{corollary}
  \end{forthel}
  ...
  \begin{forthel}
    \begin{axiom}[Set existence]\printlabel{SET_THEORY_10_2362039748001792}
      There exists a set.
    \end{axiom}
  \end{forthel}

  \begin{forthel}
    \begin{axiom}[Separation]\printlabel{SET_THEORY_10_2263707272871936}
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{axiom}[Pairing]\printlabel{SET_THEORY_10_7376893816864768}
      Let $a, b$ be objects.
  ...
  \begin{forthel}
    \begin{axiom}[Union]\printlabel{SET_THEORY_10_5536459412996096}
      Let $X$ be a system of sets.
  ...
  \begin{forthel}
    \begin{axiom}[Infinity]\printlabel{SET_THEORY_10_367388832825344}
  ...
  \begin{forthel}
    \begin{axiom}[Powerset]\printlabel{SET_THEORY_10_5862230203564032}
      Let $x$ be a set.
      Then $\pow(x)$ is a set.
    \end{axiom}
  ...
  \begin{forthel}
    \begin{axiom}[Choice]\printlabel{SET_THEORY_10_1897613305577472}
  ...
  \begin{forthel}
    \begin{axiom}[Foundation]\printlabel{SET_THEORY_10_1320008569323520}
  ...
  \begin{forthel}
    \begin{axiom}[Replacement]\printlabel{SET_THEORY_10_8142956584239104}
  ...
  \begin{forthel}
    \begin{axiom}[Function]\printlabel{SET_THEORY_10_7781693549182976}
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_5891530432708608}
      $\emptyset$ is a set.
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_4052198354845696}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_4475839687163904}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_7795203882614784}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_4458706448154624}
      Let $x, y$ be sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_5486815207227392}
      Let $X$ be a nonempty system of sets.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_7598384349184000}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_8631339572002816}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{SET_THEORY_10_8812282138066944}
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{SET_THEORY_10_3086917813927936}
      Let $x$ be a set.
      Then $x \notin x$.
    \end{corollary}
  \end{forthel}
