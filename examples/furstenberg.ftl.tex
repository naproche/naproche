...
\begin{document}
  ...
  student.\footnote{Furstenberg, Harry. \enquote{On the Infinitude of Primes}. The
  ...
  \begin{forthel}[prove off][check off]
  ...
  \begin{forthel}
    [readtex \path{set-theory/sections/01_sets/02_powerset.ftl.tex}][prove on][check on]
  \end{forthel}
