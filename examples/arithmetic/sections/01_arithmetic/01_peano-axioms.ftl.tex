...
\begin{document}
  ...
  The \nth{3} Peano axiom (also called the \textit{induction axiom}) allows us
  to prove that the signature $(0, \succ)$ captures the whole class of natural
  numbers in the sense that every natural number is either zero or a successor:
  ...
  This allows us to define the direct predecessor of a non-zero natural
  number as follows.
  ...
  Note that direct predecessors must be unique by the \nth{2} Peano axiom.
  ...
  Let us end this section by introducing new constant symbols for the first few
  successors of $0$.
