...
\begin{document}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{k \in \Nat | \classtext{$n \cdot (m + k) = (n \cdot m) + (n \cdot k)$ for all natural numbers $n,m$}}. \]
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{k \in \Nat | \classtext{$(n + m) \cdot k = (n \cdot k) + (m \cdot k)$ for all natural numbers $n,m$}}. \]
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{k \in \Nat | \classtext{$n \cdot (m \cdot k) = (n \cdot m) \cdot k$ for all natural numbers $n,m$}}. \]
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{m \in \Nat | \text{$n \cdot m = m \cdot n$ for all natural numbers $n$}}. \]
      ...
      Proof.
        ...
        Proof.
          Define \[ Q = \class{n \in \Nat | n \cdot 0 = 0 \cdot n}. \]
      ...
      Proof.
        Let us show that for all natural numbers $n$ we have $n \cdot 1 = 1 \cdot n$.
          Define \[ Q = \class{n \in \Nat | n \cdot 1 = 1 \cdot n}. \]
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{n \in \Nat | \classtext{for all natural numbers $m$ if $n \cdot k = m \cdot k$ and $k \neq 0$ then $n = m$}}. \]
