...
\begin{document}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{k' \in \Nat | \classtext{for all natural numbers $n,m$ if $n < m$ and $k' > 1$ then $n^{k'} < m^{k'}$}}. \]
      ...
      Define \[ Q = \class{k' \in \Nat | \classtext{for all natural numbers $n,m$ if $n \geq m$ then $n^{k'} \geq m^{k'}$}}. \]
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{m \in \Nat | \classtext{for all natural numbers $n$ if $k > 1$ and $n < m$ then $k^{n} < k^{m}$}}. \]
      ...
      Define \[ Q = \class{n \in \Nat | \classtext{for all natural numbers $m$ if $n \geq m$ then $k^{n} \geq k^{m}$ or $k \leq 1$}}. \]
