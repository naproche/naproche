...
\begin{document}
  ...
  \noindent In this section we will establish an order on the natural
  numbers.
  ...
  \noindent This relation enables us to to generalize the notions of direct
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{m \in \Nat | \classtext{for all natural numbers $n$ we have $n < m$ or $n = m$ or $n > m$}}. \]
