...
\begin{document}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{n \in \Nat | \classtext{for all natural numbers $m$ if $n \cdot k < m \cdot k$ then $n < m$}}. \]
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{n \in \Nat | \classtext{for all natural numbers $m$ if $n,m > k$ then $n \cdot m > k$}}. \]
