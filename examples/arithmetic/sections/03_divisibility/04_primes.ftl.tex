...
\begin{document}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define \[ P = \class{n \in \Nat | \text{if $n > 1$ then $n$ has a prime divisor}}. \]
    ...
    \end{proposition}
    \begin{proof}
      Define \[ A = \class{m \in \Nat | \text{$m$ is a nontrivial divisor of $n$}}. \]
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      Case $k > 1$.
        (1) Define \[ P = \class{n \in \Nat | \classtext{for all natural numbers $m$ if $n$ and $m$ are nonzero and $k \cdot m^{2} = n^{2}$ then $k$ is compound}}. \]
