...
\begin{document}
  ...
  Let us have a look at some easy examples of prime numbers. For a human it is
  in general not a big deal to find the first few primes. But as the following
  reveals, it is not as easy as seems to give a fully formal proof of the
  assertion that a certain number actually is prime.
  ...
  Let us now have a look at natural numbers which have no (non-trivial) common
  divisor. Such numbers are called \textit{coprime}.
