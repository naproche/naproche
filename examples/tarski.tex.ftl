...
\begin{document}'
  ...
  \begin{forthel}
    ...
    \begin{definition}[DefLB]
      Let S be a subset of T. A lower bound of S in T is an element u of T such
      that for every (x << S) u <= x.
    \end{definition}

    \begin{definition}[DefUB]
      Let S be a subset of T. An upper bound of S in T is an element u of T
      such that for every (x << S) x <= u.
    \end{definition}

    \begin{definition}[DefInf]
      Let S be a subset of T. An infimum of S in T is an element u of T such
      that u is a lower bound of S in T and for every lower bound v of S in T we
      have v <= u.
    \end{definition}

    \begin{definition}[DefSup]
      Let S be a subset of T. A supremum of S in T is an element u of T such
      that u is a upper bound of S in T and for every upper bound v of S in T we
      have u <= v.
    \end{definition}
    ...
    \begin{definition}[DefCLat]
      A complete lattice is a set S such that every subset of S has an infimum
      in S and a supremum in S.
    \end{definition}
    ...
    \begin{theorem}[Tarski]
      Let U be a complete lattice and f be an monotone function on U. Let S be
      the set of fixed points of f. S is a complete lattice.
    \end{theorem}
    \begin{proof}
      Let T be a subset of S.

      Let us show that T has a supremum in S.
        Define P = {x in U | f[x] <= x and x is an upper bound of T in U}. Take
        an infimum p of P in U. f[p] is a lower bound of P in U and an upper
        bound of T in U. Hence p is a fixed point of f and a supremum of T in S.
      end.

      Let us show that T has an infimum in S.
        Define Q = {x in U | x <= f[x] and x is a lower bound of T in U}. Take a
        supremum q of Q in U. f[q] is an upper bound of Q in U and a lower bound
        of T in U. Hence q is a fixed point of f and an infimum of T in S.
      end.
    \end{proof}
  \end{forthel}
