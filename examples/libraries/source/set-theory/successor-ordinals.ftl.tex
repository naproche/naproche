...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}[id=SET_THEORY_02_8166925802668032,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=SET_THEORY_02_1624410224066560,printid]
      Let $\alpha$ be an ordinal.
  ...
  \begin{forthel}
    \begin{definition}[id=SET_THEORY_02_7129712109289472,printid]
      A successor ordinal is an ordinal $\alpha$ such that $\alpha = \succ(\beta)$ for some ordinal $\beta$.
    \end{definition}
  \end{forthel}

  \begin{forthel}
    \begin{proposition}[id=SET_THEORY_02_8651096763400192,printid]
  ...
  \begin{forthel}
    \begin{definition}[id=SET_THEORY_02_735071524880384,printid]
