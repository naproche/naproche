...
\begin{document}
  \begin{imports}
    \begin{forthel}
      %[prove off][check off]
      [readtex \path{libraries/source/set-theory/axioms/set-existence.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/separation.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/pairing.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/union.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/powerset.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/infinity.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/replacement.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/foundation.ftl.tex}]
      [readtex \path{libraries/source/set-theory/axioms/function.ftl.tex}]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_10_5891530432708608,printid]
      $\emptyset$ is a set.
    \end{proposition}
    \begin{proof}
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_10_4052198354845696,printid]
      Let $x, y$ be sets.
