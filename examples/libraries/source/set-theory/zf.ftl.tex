...
\begin{document}
  \begin{imports}
    \begin{forthel}
      %[prove off][check off]
      [read \path{libraries/source/set-theory/axioms/set-existence.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/separation.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/pairing.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/union.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/powerset.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/infinity.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/replacement.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/foundation.ftl.tex}]
      [read \path{libraries/source/set-theory/axioms/function.ftl.tex}]
      [read \path{libraries/source/foundations/pairs-and-products.ftl.tex}]
      [read \path{libraries/source/foundations/invertible-maps.ftl.tex}]
      %[prove on][check on]
    \end{forthel}
  \end{imports}
