...
\begin{smodule}{zf.ftl}
  ...
  \begin{proposition}[forthel,id=FOUNDATIONS_10_5891530432708608,printid]
    $\emptyset$ is a set.
  \end{proposition}
  \begin{proof}[forthel]
  ...
  \begin{proposition}[forthel,id=FOUNDATIONS_10_4052198354845696,printid]
    Let $x, y$ be sets.
  ...
  \begin{proposition}[forthel,id=FOUNDATIONS_10_4475839687163904,printid]
    Let $x, y$ be sets.
