...
\begin{smodule}{transitive-classes.ftl}
  ...
  \begin{proposition}[forthel,id=SET_THEORY_01_6726468811882496,printid]
  ...
  \begin{proposition}[forthel,id=SET_THEORY_01_4884401668227072,printid]
    Let $X$ be a system of transitive sets.
  ...
  \begin{proposition}[forthel,id=SET_THEORY_01_1399002962591744,printid]
    Let $X$ be a system of sets.
  ...
  \begin{proposition}[forthel,id=SET_THEORY_01_6995689103949824,printid]
    Let $A$ be a transitive class.
