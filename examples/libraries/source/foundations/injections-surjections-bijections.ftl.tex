...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_08_8681187805495296,printid]
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_08_4195237329108992,printid]
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_1974205941809152,printid]
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_08_605931408719872,printid]
      Let $f$ be a map.
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_08_3356670992318464,printid]
      Let $A, B$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_60881194975232,printid]
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_08_8188451318923264,printid]
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_7883784041005056,printid]
      Let $A$ be a class.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_8542698338254848,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_3367836856614912,printid]
  ...
  \begin{forthel}
    \begin{corollary}[id=FOUNDATIONS_08_6435206693126144,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_2621531811217408,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_08_647446231252992,printid]
      Let $A, B$ be classes and $f : A \into B$ and $X \subseteq A$.
  ...
  \begin{forthel}
    \begin{corollary}[id=FOUNDATIONS_08_8159443759923200,printid]
      Let $A, B$ be classes and $f : A \into B$.
