...
\begin{document}
  ...
  \begin{forthel}
    \begin{definition}[id=FOUNDATIONS_14_3625613501923328,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_14_145331933151232,printid]
      Let $n, m$ be natural numbers.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_14_658708738605056,printid]
