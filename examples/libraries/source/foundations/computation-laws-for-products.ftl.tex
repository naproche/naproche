...
\begin{document}
  \begin{imports}
    \begin{forthel}
      %[prove off][check off]
      [read \path{libraries/source/foundations/computation-laws-for-classes.ftl.tex}]
      [read \path{libraries/source/foundations/pairs-and-products.ftl.tex}]
      %[prove on][check on]
    \end{forthel}
  \end{imports}
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_5719644021194752,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_4888282951319552,printid]
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_8849658323402752,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_476526841692160,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_1249567930580992,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_954964241285120,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_6495329908162560,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_3195639422779392,printid]
      Let $A, B, C$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_2677218429894656,printid]
      Let $A, A', B, B'$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_4154592050806784,printid]
      Let $A, A', B, B'$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_7090174334861312,printid]
      Let $A, A', B, B'$ be classes.
  ...
  \begin{forthel}
    \begin{proposition}[id=FOUNDATIONS_05_5552125989879808,printid]
      Let $A, A', B, B'$ be classes.
