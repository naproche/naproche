...
\begin{document}
  ...
  \begin{forthel}
    \begin{signature}\printlabel{ARITHMETIC_01_1200254566985232}
  ...
  \begin{forthel}
    \begin{axiom}[Induction]\printlabel{ARITHMETIC_01_4764664342773760}
      Let $\Phi$ be a class.
  ...
  \begin{forthel}
    \begin{axiom}\printlabel{ARITHMETIC_03_5962332515874540}
      Then $1 = 0 + 1$.
    \end{axiom}
  \end{forthel}
