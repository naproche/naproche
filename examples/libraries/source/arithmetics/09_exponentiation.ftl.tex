...
\begin{document}
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{ARITHMETIC_09_3373702288769024}
      Let $n, m, k$ be natural numbers.
      Assume $k \neq 0$.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{ARITHMETIC_09_2797602550579200}
      Let $n, m, k$ be natural numbers.
      Assume $k \neq 0$.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{ARITHMETIC_09_6875081963732992}
      Let $n, m, k$ be natural numbers.
      Assume $k \neq 0$.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{ARITHMETIC_09_3349764703780864}
      Let $n, m, k$ be natural numbers.
      Assume $k > 1$.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{ARITHMETIC_09_6780506905509888}
      Let $n, m, k$ be natural numbers.
      Assume $k > 1$.
  ...
  \begin{forthel}
    \begin{corollary}\printlabel{ARITHMETIC_09_2876620253691904}
      Let $n, m, k$ be natural numbers.
      Assume $k > 1$.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{ARITHMETIC_09_6984104377581568}
      Let $n$ be a natural number.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{ARITHMETIC_09_134060414337024}
      Let $n$ be a natural number.
      Assume $n \geq 3$.
      Then \[ n^{2} > (2 \cdot n) + 1. \]
    \end{proposition}
    \begin{proof}
      ...
      Proof.
        ...
        Proof.
          ...
          Hence $n'^{2} + (2 \cdot n') > ((2 \cdot n') + 1) + (2 \cdot n')$ (by \cref{ARITHMETIC_04_7354062662008832}).
        Qed.
  ...
  \begin{forthel}
    \begin{proposition}\printlabel{ARITHMETIC_09_1097950367318016}
      Let $n$ be a natural number.
      Assume $n \geq 5$.
      Then \[ 2^{n} > n^{2}. \]
    \end{proposition}
    \begin{proof}
      ...
      Therefore $\Phi$ contains every element of $\Nat_{\geq 5}$ (by \cref{ARITHMETIC_04_4976599269113856}).
