...
\begin{document}
  ...
  \begin{forthel}
    [readtex \path{basic-notions/sets-and-functions/sections/01_sets/04_symmetric-difference.ftl.tex}]
  \end{forthel}

  \begin{forthel}
    [readtex \path{basic-notions/sets-and-functions/sections/02_functions/02_image-and-preimage.ftl.tex}]
  \end{forthel}
