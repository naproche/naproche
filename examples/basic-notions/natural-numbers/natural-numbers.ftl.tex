...
\begin{document}
  ...
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/01_arithmetic/01_peano-axioms.ftl.tex]
    \end{forthel}
  }
  ...
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/02_ordering/02_ordering-and-addition.ftl.tex]
    \end{forthel}
  }
  ...
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/02_ordering/06_standard-exercises.ftl.tex]
    \end{forthel}
  }
  ...
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/03_divisibility/01_divisibility.ftl.tex]
    \end{forthel}
  }
  ...
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/03_divisibility/02_euclidean-division.ftl.tex]
    \end{forthel}
  }

  \subfile{sections/03_divisibility/03_primes.ftl.tex}
  \typeout{
    \begin{forthel}
      [readtex basic-notions/natural-numbers/sections/03_divisibility/03_primes.ftl.tex]
    \end{forthel}
  }
\end{document}
