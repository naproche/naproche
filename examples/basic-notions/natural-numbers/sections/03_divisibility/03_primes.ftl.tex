...
\begin{document}
  ...
  \begin{forthel}
    \begin{proposition}[NN 03 03 357744]
      Let $n > 1$.
      Then $n$ is prime iff every divisor of $n$ is a trivial divisor of $n$.
    \end{proposition}

    \begin{proposition}[NN 03 03 175431]
      $2$ and $3$ are prime.
    \end{proposition}
    \begin{proof}
    ...
    \begin{proposition}[NN 03 03 520376]
    ...
    \begin{proposition}[NN 03 03 130748]
    ...
    \begin{proposition}[NN 03 03 306779]
      Let $n$ be composite.
    ...
    \begin{proposition}[NN 03 03 356588]
    ...
    \begin{proposition}[NN 03 03 691058]
      Let $p$ be a prime number.
    ...
    \begin{proposition}[NN 03 03 703692]
      Let $p$ be a prime number.
    ...
    \begin{proposition}[NN 03 03 119851]
      Let $k$ be nonzero.
