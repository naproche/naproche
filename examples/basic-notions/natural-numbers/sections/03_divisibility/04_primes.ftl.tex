...
\begin{document}
  ...
  \begin{forthel}
    [readtex \path{basic-notions/natural-numbers/sections/01_arithmetic/04_exponentiation.ftl.tex}]
  \end{forthel}

  \begin{forthel}
    [readtex \path{basic-notions/natural-numbers/sections/02_ordering/04_ordering-and-exponentiation.ftl.tex}]
  \end{forthel}

  \begin{forthel}
    [readtex \path{basic-notions/natural-numbers/sections/02_ordering/05_induction.ftl.tex}]
  \end{forthel}

  \begin{forthel}
    [readtex \path{basic-notions/natural-numbers/sections/03_divisibility/01_divisibility.ftl.tex}]
  \end{forthel}

  \begin{forthel}
    [readtex \path{basic-notions/natural-numbers/sections/03_divisibility/02_euclidean-division.ftl.tex}]
  \end{forthel}
  ...
  \begin{forthel}
    \begin{proposition}[NN 03 04 357744]
      Let $n > 1$.
      Then $n$ is prime iff every divisor of $n$ is a trivial divisor of $n$.
    \end{proposition}

    \begin{proposition}[NN 03 04 175431]
      $2$ and $3$ are prime.
    \end{proposition}
    \begin{proof}
    ...
    \begin{proposition}[NN 03 04 520376]
    ...
    \begin{proposition}[NN 03 04 130748]
    ...
    \begin{proof}
      ...
      Thus every natural number belongs to $P$ (by NN 02 05 167446).
    \end{proof}

    \begin{proposition}[NN 03 04 306779]
      Let $n$ be composite.
    ...
    \begin{proposition}[NN 03 04 356588]
    ...
    \begin{proposition}[NN 03 04 691058]
      Let $p$ be a prime number.
    ...
    \begin{proposition}[NN 03 04 703692]
      Let $p$ be a prime number.
    ...
    \begin{proof}
      ...
      Case $p \nmid n$.
        ...
        Let us show that $n'$ divides all elements of $N$.
          ...
          Thus $p \mid r \cdot m$ (by NN 03 01 695362).
    ...
    \begin{proposition}[NN 03 04 119851]
      Let $k$ be nonzero.
    ...
    \begin{proof}
      ...
      Case $k > 1$.
        ...
        Let us show that for all natural numbers $n$ if $P$ contains all predecessors of $n$ then $P$ contains $n$.
          ...
          (2) Then $m^{2} = k \cdot l^{2}$ (by NN 01 03 169506).
          Indeed $k \cdot m^{2} = (k \cdot l)^{2} = k \cdot (k \cdot l^{2})$.

          (3) $m$ is an element of $P$. \\
          Proof.
            We have $n^{2} > m^{2}$ (by NN 02 03 252473).
        ...
        Thus $P$ contains every natural number (by NN 02 05 167446).
