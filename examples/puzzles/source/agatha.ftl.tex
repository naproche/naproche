...
to the natural language the variables are called ``\variable{a person}'' and
``\variable{another person}'' and we introduce ``killed'' by
``\variable{a person} killed \variable{another person} is an atom.''
...
Let \variable{one}, \variable{a person}, \variable{another person} stand for persons.
...
\begin{signature}
\Variable{a person} lives in Dreadsbury mansion is an atom.
\end{signature}
...
\begin{signature}
\Variable{a person} hates \variable{another person} is an atom.
\end{signature}

Let Q is hated by P stand for P hates Q.

\begin{signature}
\Variable{a person} is richer than \variable{another person} is an atom.
\end{signature}
...
\begin{axiom}
Charles hates no \variable{one} that is hated by Aunt Agatha.
\end{axiom}

\begin{axiom}
Agatha hates every \variable{one} that is not the butler.
\end{axiom}

\begin{axiom}
The butler hates every \variable{one} that is not richer than Aunt Agatha.
\end{axiom}

\begin{axiom}
The butler hates every \variable{one} that is hated by Agatha.
\end{axiom}

\begin{axiom}
No \variable{one} hates every person.
\end{axiom}
