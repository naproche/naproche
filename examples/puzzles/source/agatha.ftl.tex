...
to the natural language the variables are called ``\var{a person}'' and
``\var{another person}'' and we introduce ``killed'' by
``\var{a person} killed \var{another person} is an atom.''
...
Let \var{one}, \var{a person}, \var{another person} stand for persons.
...
\begin{signature}
\Var{a person} lives in Dreadsbury mansion is an atom.
\end{signature}
...
\begin{signature}
\Var{a person} hates \var{another person} is an atom.
\end{signature}

Let Q is hated by P stand for P hates Q.

\begin{signature}
\Var{a person} is richer than \var{another person} is an atom.
\end{signature}
...
\begin{axiom}
Charles hates no \var{one} that is hated by Aunt Agatha.
\end{axiom}

\begin{axiom}
Agatha hates every \var{one} that is not the butler.
\end{axiom}

\begin{axiom}
The butler hates every \var{one} that is not richer than Aunt Agatha.
\end{axiom}

\begin{axiom}
The butler hates every \var{one} that is hated by Agatha.
\end{axiom}

\begin{axiom}
No \var{one} hates every person.
\end{axiom}
