...
Let \variable{a dwarf} denote dwarfs.

\begin{signature}
A hat is a notion.
\end{signature}

Let \variable{a hat} denote a hat.

\begin{signature}
The hat of \variable{a dwarf} is a hat.
\end{signature}
...
Let \variable{a color} denote a color.

\begin{signature}
The opposite color of \variable{a color} is a color.
\end{signature}
...
\begin{signature}
The color of \variable{a hat} is a color.
\end{signature}

\begin{axiom}
The color of the hat of \variable{a dwarf} is White or Black.
\end{axiom}

\begin{signature}
\Variable{a dwarf} names \variable{a color} is an atom.
\end{signature}

\begin{signature}
\Variable{a dwarf} gets released is an atom.
\end{signature}
