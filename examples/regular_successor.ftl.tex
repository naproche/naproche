...
\section{Ordinals}
  ...
  We only need transitivity for cardinals.
  This limited transitivity axiom keeps the search space smaller for automated proof search.
    ...
    \begin{proof}
      ...
      $\dom(h) = \Prod{\kappa}{\kappa}$.
        ...
        proof.
          ...
          Then $n = g(f(a))(b)$. $f(a)$ is an element of $\Succ{\kappa}$. Every
          element of $f(a)$ is an element of $\Succ{\kappa}$.
