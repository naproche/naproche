...
\begin{document}
  ...
  \begin{imports}
    \begin{forthel}
      ...
      [read \path{libraries/source/foundations/universal-class.ftl.tex}]
      [read \path{libraries/source/foundations/proper-classes.ftl.tex}]
      [read \path{libraries/source/foundations/closure-under-arbitrary-unions.ftl.tex}]
      [read \path{libraries/source/foundations/closure-under-powersets.ftl.tex}]
      %[prove on][check on]
    \end{forthel}
  \end{imports}
