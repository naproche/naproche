...
\begin{document}
  ...
  \begin{imports}
    \begin{forthel}
      %[prove off][check off]
      [read \path{libraries/source/set-theory/cardinals-and-maps.ftl.tex}]
      [read \path{libraries/source/set-theory/successor-cardinals.ftl.tex}]
      [read \path{libraries/source/set-theory/regular-cardinals.ftl.tex}]
      [read \path{libraries/source/foundations/constant-maps.ftl.tex}]
      %[prove on][check on]
    \end{forthel}
  \end{imports}
