...
\begin{sparagraph}
  \emph{\sn{Cantor's First Paradox}}, discovered by \sr{Cantor}{Georg Cantor} in 1897, states that there cannot exists a set that contains all cardinal numbers \cite[chapter 156]{Cantor1991}.
\end{sparagraph}
