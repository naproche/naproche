...
\begin{sparagraph}
  ...
  It was discussed in \sn[post='s]{Russell} 1903 \emph{rinciples of Mathematics} \cite[Appendix B]{Russell1903} and rediscovered in 1958 by \sr{Myhill}{John Myhill} \cite{Myhill1958}.
\end{sparagraph}
