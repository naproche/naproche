...
\begin{sparagraph}
  The \emph{\sn{Russell-Myhill Paradox}} is a paradox discovered by \sr{Russell}{Bertrand Russell} which states that two systems of propositions with the same so-called \emph{logical product} are not necessarily equal.
