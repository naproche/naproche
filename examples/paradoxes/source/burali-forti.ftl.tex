...
\begin{sparagraph}
  \emph{\sn{Burali-Forti's Paradox}}, named after \sr{Burali-Forti}{Cesare Burali-Forti}, demonstates that there cannot exists a set that contains all ordinal number \cite{BuraliForti1897}.
\end{sparagraph}
