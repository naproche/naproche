...
\begin{sparagraph}
  \emph{\sn{Hilbert's Paradox}}, discovered around 1900 by \sr{Hilbert}{David Hilbert}, demonstates that there cannot exists a set that is closed under powerset and under union of arbitrary subset \cite{PeckhausKahl2002}.
\end{sparagraph}
...
\begin{sparagraph}
  Using \sn{Hilbert's Paradox} it can further be shown that there exists no universal set.
\end{sparagraph}
