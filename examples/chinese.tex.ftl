...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{definition}[DefSSum]
      X +' Y is a set such that for every element z (z << X +' Y) iff there
      exist x << X, y << Y such that z = x + y.
    \end{definition}

    \begin{definition}[DefSInt]
      X ** Y is a set such that for every element z (z << X +' Y) iff z << X and
      z << Y.
    \end{definition}
    ...
    \begin{theorem}[ChineseRemainder]
      Suppose that every element belongs to I +' J. Let x, y be elements. There
      exists an element w such that w = x (mod I) and w = y (mod J).
    \end{theorem}
    \begin{proof}
    ...
    \begin{definition}[DefGCD]
      A gcd of x and y is a common divisor c of x and y such that any common
      divisor of x and y divides c.
    \end{definition}
    ...
    \begin{definition}[DefPrIdeal]
      <c> is a set such that for every z z is an element of <c> iff there exists
      an element x such that z = c * x.
    \end{definition}
  ...
  \begin{theorem}[GCDin]
    Let a, b be elements. Assume that a is nonzero or b is nonzero. Let c be a
    gcd of a and b. Then c belongs to <a> +' <b>.
  \end{theorem}
  \begin{proof}
