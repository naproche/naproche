...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{axiom}[Ext]
      If $x$ is an element of $C$ iff $x$ is an element of $B$ then $C = B$.
    \end{axiom}
    ...
    \begin{definition}
      The union of D is a class B such that (x is in B iff there is a C 
    ...
    \begin{definition}
      The union of D and B is a class C such that C is the union of the pair of D and B.
    \end{definition}
    ...
    \begin{axiom}[PowerSet]
      b is the powerset of d iff (c is in b iff c is a subclass of d).
    \end{axiom}
