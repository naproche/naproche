...
\usepackage[stex,supplements]{naproche}
...
our formalizations (\path{examples/preliminaries/source/vocabulary.ftl.tex}).
...
useful mathematical phrases (\path{examples/preliminaries/source/macros.ftl.tex}).
...
\begin{forthel}
  ...
  \begin{definition}
    The intersection of $S$ and $T$ is $\fclass{x \in S}{ \in T}$.
  \end{definition}

  Let $S \cap T$ stand for the intersection of $S$ and $T$.

  \begin{definition}
    The union of $S$ and $T$ is $\fclass{x}{x \in S \vee x \in T}$.
  \end{definition}

  Let $S \cup T$ stand for the union of $S$ and $T$.

  \begin{definition}
    The set difference of $S$ and $T$ is $\fclass{x \in S}{x \notin T}$.
  \end{definition}
...
\begin{forthel}
  ...
  \begin{definition}
    $S \times T = \fclass{(x,y)}{\text{$x \in S$ and $y \in T$}}$.
  \end{definition}
