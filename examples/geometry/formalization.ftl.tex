...
\end{comment}
  ...
  \begin{forthel}
    \begin{axiom}[Segment construction] % SST A4
  ...
  \begin{forthel}
    ...
    \begin{lemma}[Extension to quaternary betweenness] % Satz 3.12, specialized to $n = 3$ and $l = 1$.
    ...
    \begin{proof}
      ...
      Proof.
        ...
        Take a point $b'$ such that
          %%% $\Betw{d}{c'}{b'}$ and  % No longer necessary.
          $\Betw{a}{c'}{b'}$ and
          $\Cong{c'}{b'}{c}{b}$.
        Take a point $b''$ such that
          %%% $\Betw{c}{d'}{b''}$ and  % No longer necessary.
          $\Betw{a}{d'}{b''}$ and
          $\Cong{b}{d}{d'}{b''}$.
        %
