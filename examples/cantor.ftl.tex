...
\begin{document}
  ...
  \begin{forthel}
    [readtex \path{preliminaries/source/preliminaries.ftl.tex}]
  \end{forthel}
  ...
  \begin{forthel}
    ...
    \begin{definition*}
      ...
      $f$ surjects onto $Y$ iff $Y = \compterm{f(x)}{x \in \dom(f)}$.
    \end{definition*}
  ...
  \begin{forthel}
    ...
    \begin{proof}
      ...
      Define \[ N = \compterm{x \in M}{\text{$x$ is not an element of $f(x)$}}. \]
      $N$ is a subset of $M$.
