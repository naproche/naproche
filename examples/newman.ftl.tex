...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{definition}
      $R$ is locally confluent iff for all $a, b, c$ such that $a \reduces{R} b, c$
    ...
    \begin{definition}
      A normal form of $x$ in $R$ is an element $y$ such that $x \reducesTCR{R} y$ and $y$ has no reducts in $R$.
    \end{definition}
