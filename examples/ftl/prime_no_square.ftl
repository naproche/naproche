...
Signature.
r * q is a positive rational number.
...
Definition.
q is left cancellative iff for all r, s we have q * s = q * r => s = r.
...
Definition.
n | m iff there exists k such that k * n = m.
...
Proof by contradiction.
  ...
  Take a natural number k such that n = k * p.
  Then p * m^2 = p * (k * n).
