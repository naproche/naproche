...
\begin{document}
  ...
  Let us start by introducing the signature the ring of integers.
  ...
  Note that we have declared $q$ as a \textit{non-zero} integer. Otherwise every set $A$ would be open since $0 \Int + a = \emptyset \subseteq A$ for every $a \in A$.
