...
\begin{document}
  ...
  Let us assume that some finite field is a model of our current theory. Recall that in any finite field every non-zero element is a divisor of $1$. Let us reformulate axiom \textit{PrimeDivisor}:
