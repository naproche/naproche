...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{signature}[id=Integers]
      An integer is an object.
    \end{signature}

    Let $a,b,c,d,i,j,k,l,m,n$ stand for integers.

    \begin{signature}[id=IntZero]
      $0$ is an integer.
    \end{signature}

    \begin{signature}[id=IntOne]
      $1$ is an integer.
    \end{signature}

    \begin{signature}[id=IntNeg]
      $-a$ is an integer.
    \end{signature}

    \begin{signature}[id=IntPlus]
      $a + b$ is an integer.
    \end{signature}

    \begin{signature}[id=IntMult]
  ...
  \begin{forthel}
    ...
    \begin{axiom}[id=MulOne]
      $a \cdot 1 = a = 1 \cdot a$.
    \end{axiom}

    \begin{axiom}[id=Distrib]
  ...
  \begin{forthel}
    \begin{axiom}[id=NonTriv]
      $0 \neq 1$.
    \end{axiom}

    \begin{axiom}[id=ZeroDiv]
  ...
  \begin{forthel}
    ...
    \begin{definition}[id=EquMod]
      $a = b ~(\mod q)$ iff $q \mid a-b$.
    \end{definition}

    \begin{lemma}[id=EquModRef]
      $a = a ~(\mod q)$.
    \end{lemma}

    \begin{lemma}[id=EquModSym]
  ...
  \begin{forthel}
    \begin{signature}[id=Prime]
      $a$ is prime is an atom.
    \end{signature}

    Let a prime stand for a prime nonzero integer.

    \begin{axiom}[id=PrimeDivisor]
  ...
  \begin{forthel}
    ...
    \begin{definition}[id=Complement]
  ...
  \begin{forthel}
    \begin{definition}[id=Closed]
      $A$ is closed iff $\overline{A}$ is open.
    \end{definition}

    \begin{definition}[id=OpenIntegerSets]
  ...
  \begin{forthel}
    \begin{theorem}[title=Fuerstenberg]
