...
\begin{document}
  ...
  \begin{forthel}
    ...
    \begin{signature}[id=Cardinality]
      $|X|$ is a cardinal.
    \end{signature}

    \begin{axiom}[title=existence of surjection,id=existence_of_surjection]
  ...
  \begin{forthel}
    ...
    \begin{definition}[id=Cofinality]
      Let $\kappa$ be a cardinal.
