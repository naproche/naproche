...
\symdef{FUNdom}{\highlight{\textrm{dom}}}
\symdef{FUNid}[args=1]{\highlight{\textrm{id}}_{#1}}
\symdef{FUNrange}{\highlight{\textrm{range}}}
\symdef{FUNcomp}{\mathbin{\highlight\circ}}
\symdef{FUNrest}{\mathbin{\highlight\restriction}}
\symdef{FUNim}[args=2]{#1\highlight[#2\highlight]}
\notation{FUNim}[parens]{#1\highlight(#2\highlight)}
\notation{FUNim}[star]{#1_{\highlight*}\highlight(#2\highlight)}
\symdef{FUNpreim}[args=2]{#1^{\highlight{-1}}\highlight[#2\highlight]}
\notation{FUNpreim}[parens]{#1^{\highlight{-1}}\highlight(#2\highlight)}
\notation{FUNpreim}[star]{#1^{\highlight*}\highlight(#2\highlight)}
\symdef{FUNfromto}[args=2]{\mathbin{\highlight:}#1\mathbin{\highlight\rightarrow}#2}
\symdef{FUNfunspace}[args=2]{\highlight[#1\mathbin{\highlight\rightarrow}#2\highlight]}
...
\begin{sfragment}{Maps Between Classes}
  \inlineforthel{[synonym map/-s][synonym function/-s]}
