...
\begin{sfragment}{Range}
  ...
  \begin{definition}[forthel,id=FOUNDATIONS_06_4284980337311744]
    Let $f$ be a map.
    A \emph{value of $f$} is an object $b$ such that $b \eq f(a)$ for some $a \in \dom(f)$.
  \end{definition}

  \begin{definition}[forthel,id=FOUNDATIONS_06_1938831225913344]
    Let $f$ be a map.
    $\emph{\FUNrange(f)} = \{ f(a) \mid a \in \dom(f) \}$.
  ...
  \begin{proposition}[forthel,id=FOUNDATIONS_06_6386349418479616]
    ...
    $b$ is a value of $f$ iff $b \in \FUNrange(f)$.
  \end{proposition}
  \begin{proof}[forthel]
    \begin{case}{$b$ is a value of $f$.}
      Take $a \in \dom(f)$ such that $b \eq f(a)$.
      $b$ is an object.
      Hence $b \in \FUNrange(f)$.
    \end{case}

    \begin{case}{$b \in \FUNrange(f)$.}
      Then $b$ is an object such that $b \eq f(a)$ for some $a \in \dom(f)$.
...
\begin{sfragment}{Identity Map}
  \begin{definition}[forthel,id=FOUNDATIONS_06_1920902360989696]
    Let $A$ be a class.
    $\emph{\FUNid{A}}$ is the map defined on $A$ such that $\FUNid{A}(a) \eq a$ for all $a \in A$.
...
\begin{sfragment}{Image and Preimage}
  \begin{definition}[forthel,id=FOUNDATIONS_06_3038237683613696]
    ...
    $\emph{\FUNim{f}{A}} = \{ f(a) \mid a \in \dom(f) \SETintersect A \}$.
  ...
  \begin{definition}[forthel,id=FOUNDATIONS_06_4563167805964288]
    ...
    $\emph{\FUNpreim{f}{B}} = \{ a \in \dom(f) \mid f(a) \in B \}$.
