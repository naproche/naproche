...
\begin{sfragment}{Basic Properties}
  ...
  \begin{proof}[forthel]
    ...
    Case $g \FUNcomp f \eq \FUNid{A}$ and $f \FUNcomp g \eq \FUNid{B}$.
      Then $\dom(g)
        \eq B
        \eq \FUNrange(f)$
      and $\FUNrange(g)
  ...
  \begin{proposition}[forthel,id=FOUNDATIONS_09_6374884963778560]
    ...
    Assume that $f$ is invertible.
    Then $f \restriction X$ is invertible and $\FUNinv{f\restriction X} \eq \FUNinv{f} \restriction (\FUNim{f}{X})$.
  \end{proposition}
  \begin{proof}[forthel]
    $f \restriction X$ is a surjective map from $X$ onto $\FUNim{f}{X}$.
    Take $g \eq \FUNinv{f} \restriction (\FUNim{f}{X})$.
    ...
    Let us show that $\FUNrange(g) \SETinclude X$.
      ...
      Then $a
        \eq (\FUNinv{f} \restriction (\FUNim{f}{X}))(b)
        \eq \FUNinv{f}(b)
        \eq \FUNinv{f}(f(c))
        \eq c$.
      Hence $a \in X$.
    ...
    Let us show that $g((f \restriction X)(a)) \eq a$ for all $a \in X$.
      Let $a \in X$.
      Then $g((f \restriction X)(a))
        \eq g(f(a))
        \eq (\FUNinv{f} \restriction (\FUNim{f}{X}))(f(a))
        \eq \FUNinv{f}(f(a))
        \eq a$.
    End.

    Let us show that $((f \restriction X)(g(b))) \eq b$ for all $b \in \FUNim{f}{X}$.
      Let $b \in \FUNim{f}{X}$.
      ...
      Hence $(f \restriction X)(g(b))
        \eq (f \restriction X)(a)
        \eq f(a)
        \eq b$.
    End.

    Thus $g \FUNcomp (f \restriction X) \eq \FUNid{X}$ and $(f \restriction X) \FUNcomp g \eq \FUNid{\FUNim{f}{X}}$.
  ...
  \end{proposition}
  \begin{proof}[forthel]
    We have $\FUNim{\FUNinv{f}}{Y} \eq \{ \FUNinv{f}(b) \mid b \in Y \}$ and $\FUNpreim{f}{Y} \eq \{ a \in A \mid f(a) \in Y \}$.
  ...
  \begin{proof}[forthel]
    ...
    We have $\FUNim{\FUNinv{f}}{\SETsingleton{b}} \eq \{ \FUNinv{f}(c) \mid c \in \SETsingleton{b} \}$.
...
\begin{sfragment}*{Involutions}
  ...
  \end{proposition}
  \begin{proof}[forthel]
    Case $g \FUNcomp f$ is an involution on $A$.
    ...
    Case $g \FUNcomp f \eq f \FUNcomp g$.
