...
\symdef{FUNfromonto}[args=2]{\mathbin{\highlight:}#1\mathbin{\highlight\twoheadrightarrow}#2}
\symdef{FUNfrominto}[args=2]{\mathbin{\highlight:}#1\mathbin{\highlight\hookrightarrow}#2}

\begin{sfragment}{Surjective Maps}
  \inlineforthel{[synonym surject/-s]}
...
\begin{sfragment}{Bijective Maps}
  \inlineforthel{[synonym bijection/-s]}
  ...
  \inlineforthel{[synonym permutation/-s]}
