...
\begin{sfragment}{Equality and Elementhood}
  \begin{convention}
    Let $x\SETin y$ stand for $x$ is an element of $y$.
    Let $x\SETnotin y$ stand for $x$ is not an element of $y$.
    Let $x\eq y$ stand for $x$ is equal to $y$.
  \end{convention}
\end{sfragment}
