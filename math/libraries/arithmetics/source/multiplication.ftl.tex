...
\begin{sfragment}{Definition}
  \inlineforthel{[synonym product/-s]}
...
\begin{sfragment}{Computation Laws}
  \begin{sfragment}{Distributivity}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ k' \SETin \Nat \mid n \NATmul (m \NATplus k') \eq (n \NATmul m) \NATplus (n \NATmul k') \}$.
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ k' \SETin \Nat \mid (n \NATplus m) \NATmul k' \eq (n \NATmul k') \NATplus (m \NATmul k') \}$.
  ...
  \begin{sfragment}{Associativity}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ k' \SETin \Nat \mid n \NATmul (m \NATmul k') \eq (n \NATmul m) \NATmul k' \}$.
  ...
  \begin{sfragment}{Commutativity}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ m' \SETin \Nat \mid n \NATmul m' \eq m' \NATmul n \}$.

      (1) $\NATzero$ is contained in $\Phi$.
      \begin{proof}
        Define $\Psi = \{ n' \SETin \Nat \mid n' \NATmul \NATzero \eq \NATzero \NATmul n' \}$.
      ...
      \begin{proof}
        Define $\Theta = \{ n' \SETin \Nat \mid n' \NATmul \NATone \eq \NATone \NATmul n' \}$.
  ...
  \begin{sfragment}{Cancellation}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ n' \SETin \Nat \mid\text{ for all }m' \SETin \Nat\text{ if }n' \NATmul k \eq m' \NATmul k\text{ and }k \neq \NATzero\text{ then }n' \eq m' \}$.
