...
\symdef{NATgeq}{\;\geq\;}
\symdef{NATngeq}{\;\not\geq\;}
\symdef{Natlessthan}[args=1]{\mathbb{N}_{<#1}}
\symdef{Natgtrthan}[args=1]{\mathbb{N}_{>#1}}
\symdef{Natleqthan}[args=1]{\mathbb{N}_{\leq#1}}
\symdef{Natgeqthan}[args=1]{\mathbb{N}_{\geq#1}}
