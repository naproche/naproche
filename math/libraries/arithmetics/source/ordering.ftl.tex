...
\symdef{NATless}{\mathrel{\highlight<}}
\symdef{NATnless}{\mathrel{\highlight{\not<}}}
\symdef{NATgtr}{\mathrel{\highlight>}}
\symdef{NATngtr}{\mathrel{\highlight{\not>}}}
\symdef{NATleq}{\mathrel{\highlight\leq}}
\symdef{NATnleq}{\mathrel{\highlight{\not\leq}}}
\symdef{NATgeq}{\mathrel{\highlight\geq}}
\symdef{NATngeq}{\mathrel{\highlight{\not\geq}}}
\symdef{Natlessthan}[args=1]{\highlight{\mathbb{N}}_{\highlight<#1}}
\symdef{Natgtrthan}[args=1]{\highlight{\mathbb{N}}_{\highlight>#1}}
\symdef{Natleqthan}[args=1]{\highlight{\mathbb{N}}_{\highlight\leq#1}}
\symdef{Natgeqthan}[args=1]{\highlight{\mathbb{N}}_{\highlight\geq#1}}
...
\begin{sfragment}{Definitions and Immediate Consequences}
  ...
  \begin{definition}[forthel,id=ARITHMETIC_04_3668680374222848]
    ...
    $\emph{\Natlessthan{n}} = \{ k \in \Nat \mid k \NATless n \}$.
  \end{definition}

  \begin{definition}[forthel,id=ARITHMETIC_04_3670333934534656]
    Let $n$ be a natural number.
    $\emph{\Natgtrthan{n}} = \{ k \in \Nat \mid k \NATgtr n \}$.
  \end{definition}
