...
\symdef{NATplus}{\mathbin{\highlight+}}
\symdef{NATzero}{\highlight0}
\symdef{NATone}{\highlight1}
\symdef{NATtwo}{\highlight2}
\symdef{NATthree}{\highlight3}
\symdef{NATfour}{\highlight4}
\symdef{NATfive}{\highlight5}
\symdef{NATsix}{\highlight6}
\symdef{NATseven}{\highlight7}
\symdef{NATeight}{\highlight8}
\symdef{NATnine}{\highlight9}
