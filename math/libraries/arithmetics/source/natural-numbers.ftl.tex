...
\begin{sfragment}{Immediate Consequences of the Axioms}
  ...
  \end{proposition}
  \begin{proof}[forthel]
    Define $\Phi = \{ n' \SETin \Nat \mid n' \eq \NATzero\text{ or }n' \eq m' \NATplus \NATone\text{ for some natural number }m' \}$.
...
\begin{sfragment}{Computation Laws for Addition}
  \begin{sfragment}{Associativity}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ k' \SETin \Nat \mid n \NATplus (m \NATplus k') \eq (n \NATplus m) \NATplus k' \}$.
  ...
  \begin{sfragment}{Commutativity}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ m' \SETin \Nat \mid n \NATplus m' \eq m' \NATplus n \}$.

      (1) $\NATzero$ is an element of $\Phi$.
      \begin{proof}
        Define $\Psi = \{ n' \SETin \Nat \mid n' \NATplus \NATzero \eq \NATzero \NATplus n' \}$.
      ...
      \begin{proof}
        Define $\Theta = \{ n' \SETin \Nat \mid n' \NATplus \NATone \eq \NATone \NATplus n' \}$.
  ...
  \begin{sfragment}{Cancellation}
    ...
    \end{proposition}
    \begin{proof}[forthel]
      Define $\Phi = \{ k' \SETin \Nat \mid\text{ if }n \NATplus k' \eq m \NATplus k'\text{ then }n \eq m \}$.
