...
\begin{definition}[forthel,id=ARITHMETIC_07_4239998993825792]
  ...
  \emph{$n$ divides $m$} iff there exists a natural number $k$ such that $n \NATmul k \eq m$.

  Let $m$ is \emph{divisible by $n$} stand for $n$ divides $m$.
  Let $\emph{n \NATmid m}$ stand for $n$ divides $m$.
  Let $\emph{n \NATnmid m}$ stand for $n$ does not divide $m$.
\end{definition}
