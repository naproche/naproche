...
\begin{proof}[forthel]
  ...
  \[ x \SETdiff F[\alpha] \neq \SETempty \implies F(\alpha) \SETin x \SETdiff F[\alpha] \]
  and
  \[ x \SETdiff F[\alpha] \eq \SETempty \implies F(\alpha) \eq x. \]
  \begin{proof}
    Let $\alpha \SETin \Ord$.
    We have $\FUNim{F}{\alpha} \eq \{ F(\beta) \mid \beta \SETin \alpha \}$.
    Hence $\FUNim{F}{\alpha} \eq \{ G(F \FUNrest \beta) \mid \beta \SETin \alpha \}$.
    We have $\FUNrange(F \FUNrest \alpha) \eq \{ F(\beta) \mid \beta \SETin \alpha \}$.
  ...
  Define $\Phi = \{ \alpha \SETin \Ord \mid F(\alpha) \eq x \}$.
  $\Phi$ is nonempty.
