...
\begin{proof}[forthel]
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      Hence $\NATexp{n'}{\NATtwo} \NATplus (\NATtwo \NATmul n') \NATgtr ((\NATtwo \NATmul n') \NATplus \NATone) \NATplus (\NATtwo \NATmul n')$ (by \sn{preservation of ordering under right-addition}).
    \end{proof}
    ...
    \begin{proof}
      ...
      Thus $\NATtwo \NATmul (n' \NATplus n') \NATgtr \NATtwo \NATmul (n' \NATplus \NATone)$ (by \sn{preservation of ordering under left-multiplication}).
  ...
  Therefore $\Phi$ contains every element of $\Natgeqthan{\NATthree}$ (by \sr{induction III}{induction}, 1, 2).
...
\begin{proof}[forthel]
  ...
  Therefore $\Phi$ contains every element of $\Natgeqthan{\NATfive}$ (by \sr{induction III}{induction}).
