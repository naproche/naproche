...
\begin{proof}[forthel]
  ...
  \begin{proof}
    ...
    Therefore $n \Elem \Psi$ for every $n \Elem \Nat$ (by \printref{ARITHMETIC_01_4764664342773760}).
  \end{proof}
  ...
  \begin{proof}
          ...
          \begin{case}{$x \NotEq a$.}
            ...
            Let us show that $H \Elem \Phi$.
              ...
              \begin{proof}
                ...
                We have $(n \NATplus \NATone, f(b)) \NotEq (\NATzero,x)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
          ...
          \begin{case}{$y \NotEq a$.}
            ...
            Let us show that $H \Elem \Phi$.
              ...
              \begin{proof}
                ...
                Assume $(n,b) \Elem H$.
                Then $(n \NATplus \NATone, f(b)) \Elem \SETintersectover \Phi$.
                We have $(n \NATplus \NATone, f(b)) \NotEq (\NATzero,y)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
                Indeed $n \NATplus \NATone \NotEq \NATzero$.
                Hence $(n \NATplus \NATone, f(b)) \Elem H$.
              \end{proof}
      ...
      (n \NATplus \NATone, y) \Elem \SETintersectover \Phi$ then $x \Eq f(b) \Eq y$.
        ...
        \begin{case}{$x \NotEq f(b)$.}
          ...
          \begin{proof}
            ...
            Indeed $(\NATzero,a) \NotEq (n \NATplus \NATone,x)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
          ...
          \begin{proof}
            ...
            $(m \NATplus \NATone,f(z)) \NotEq (n \NATplus \NATone,x)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
        ...
        \begin{case}{$y \NotEq f(b)$.}
          ...
          \begin{proof}
            ...
            Indeed $(\NATzero,a) \NotEq (n \NATplus \NATone,y)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
            Indeed $\NATzero \NotEq n \NATplus \NATone$.
          \end{proof}
          ...
          \begin{proof}
            ...
            Then $(m,z) \Elem \SETintersectover \Phi$.
            Hence $(m \NATplus \NATone,f(z)) \Elem \SETintersectover \Phi$.
            $(m \NATplus \NATone,f(z)) \NotEq (n \NATplus \NATone,y)$ (by \printref{FOUNDATIONS_04_8464577431863296}).
    ...
    Consequently $n \Elem \Theta$ for every $n \Elem \Nat$ (by \printref{ARITHMETIC_01_4764664342773760}).
  \end{proof}
