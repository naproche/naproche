          ...
          \begin{case}{$x \NotEq a$.}
            ...
            Let us show that $H \Elem \Phi$.
              ...
              \begin{proof}
                ...
                Indeed $n \NATplus \NATone, \NATzero, f(b), x$ are objects and $n \NATplus \NATone \NotEq \NATzero$.
      ...
      (n \NATplus \NATone, y) \Elem \SETintersectover \Phi$ then $x \Eq f(b) \Eq y$.
        ...
        \begin{case}{$x \NotEq f(b)$.}
          ...
          \begin{proof}
            ...
            Indeed $n \NATplus \NATone, \NATzero, a, x$ are objects and $\NATzero \NotEq n \NATplus \NATone$.
          \end{proof}
          ...
          \begin{proof}
            ...
            $m \NATplus \NATone, n \NATplus \NATone, f(z), x$ are objects.
            [prover vampire]
            Thus if $(m \NATplus \NATone,f(z)) \Eq (n \NATplus \NATone,x)$ then $m \NATplus \NATone \Eq n \NATplus \NATone$ and $f(z) \Eq x$.
            Therefore if $(m \NATplus \NATone,f(z)) \Eq (n \NATplus \NATone,x)$ then $m \Eq n$ and $f(z) \Eq x$ (by \sn{injectivity of successor function}).
            Consequently $(m \NATplus \NATone,f(z)) \NotEq (n \NATplus \NATone,x)$.
        ...
        \begin{case}{$y \NotEq f(b)$.}
          ...
          \begin{proof}
            ...
            Indeed $\NATzero, n \NATplus \NATone, a, y$ are objects and $(\NATzero,a) \NotEq (n \NATplus \NATone,y)$.
          ...
          \begin{proof}
            ...
            Then $(m,z) \Elem \SETintersectover \Phi$.
            Hence $(m \NATplus \NATone,f(z)) \Elem \SETintersectover \Phi$.
            $m \NATplus \NATone, n \NATplus \NATone, f(z), y$ are objects.
            [prover vampire]
            Thus if $(m \NATplus \NATone,f(z)) \Eq (n \NATplus \NATone,y)$ then $m \NATplus \NATone \Eq n \NATplus \NATone$ and $f(z) \Eq y$.
            Therefore if $(m \NATplus \NATone,f(z)) \Eq (n \NATplus \NATone,y)$ then $m \Eq n$ and $f(z) \Eq y$ (by \sn{injectivity of successor function}).
            Consequently $(m \NATplus \NATone,f(z)) \NotEq (n \NATplus \NATone,y)$.
