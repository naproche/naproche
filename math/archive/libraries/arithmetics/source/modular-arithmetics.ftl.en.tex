...
\symdef{NATcong}[args=3]{#1\;\comp\equiv\;#2\;\comp{(\textrm{mod}}\,#3\comp)}
\symdecl*{quotient}
\symdecl*{remainder}
\symdecl*{congruent}

\begin{sfragment}{Quotients and Remainders}
  \begin{definition}[forthel,for={NATdiv,quotient}]
  ...
  \begin{definition}[forthel,for={NATmod,remainder}]
    Let $n, m$ be natural numbers such that $m \NotEq \NATzero$.
...
\begin{sfragment}{Basic Properties}
  \begin{definition}[forthel,for={NATcong,congruent}]
