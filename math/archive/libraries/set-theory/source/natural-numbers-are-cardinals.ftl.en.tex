...
\begin{proof}[forthel]
  ...
  \begin{proof}
    ...
    Let us show that $\ORDsucc(n') \ORDleq \SETcard{\ORDsucc(n')}$.
      ...
      We can show that $\FUNinv{f}(n') \ORDless m$.
        ...
        $f \FUNrest m$ is a bijection between $m$ and $\FUNim{f}{m}$ (by \sn{bijectivity of restriction of injection}).
  ...
  Thus $\ORDomega \SETinclude \Phi$ (by \sn{transfinite induction III}).
