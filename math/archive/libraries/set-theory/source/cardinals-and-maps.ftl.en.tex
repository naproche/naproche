...
\end{proposition}
\begin{proof}[forthel]
  There exists an injective map from $x$ to $y$ and there exists no surjective map from $x$ onto $y$ iff $\SETcard{x} \ORDleq \SETcard{y}$ and $\SETcard{x} \ORDngeq \SETcard{y}$ (by \sn{existence condition for injections}, \sn{existence condition for surjections}).
...
\begin{proof}[forthel]
  ...
  \begin{case}{$a$ is nonempty.}
    ...
    Hence $\SETcard{\FUNim{f}{a}} \ORDleq \SETcard{a}$ (by \sn{existence condition for surjections}).
