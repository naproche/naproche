...
\symdecl*{transfinite induction I}
\symdecl*{transfinite induction II}
...
\begin{proof}[forthel]
  ...
  [prover vampire]
  Hence $B$ contains every set (by \sr{epsilon induction}{$\in$-induction}).
  [prover eprover]
...
\begin{proof}[forthel]
  ...
  [prover vampire]
  Thus $\Phi$ contains every ordinal (by \sn{transfinite induction I}).
  [prover eprover]
\end{proof}
\end{smodule}
\end{document}
