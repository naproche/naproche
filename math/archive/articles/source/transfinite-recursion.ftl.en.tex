...
\begin{proof}[forthel]
  ...
  \begin{proof}
    ...
    Let us show that for every ordinal $\alpha$ if every ordinal less than $\alpha$ lies in $\Phi$ then $\alpha \Elem \Phi$.
      ...
      We can show that $H' \FUNrest \beta \Elem \Dom(G)$ for every $\beta \Elem \ORDsucc(\alpha)$.
        Let $\beta \Elem \ORDsucc(\alpha)$.
        $H' \FUNrest \beta$ is a function.
        Indeed $H' \FUNrest \beta$ is a map and $\Dom(H' \FUNrest \beta)$ is a set.
        Hence $H' \FUNrest \beta$ is a function from $\beta$ to $A$.
        Thus $H' \FUNrest \beta \Elem \ORDfunspace{A}$.
        Therefore  $H' \FUNrest \beta \Elem \Dom(G)$.
      End.
