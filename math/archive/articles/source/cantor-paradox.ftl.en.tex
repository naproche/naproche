...
\symdecl*{Cantor Paradox I}
\symdecl*{Cantor Paradox II}
...
\begin{theorem}[forthel,title=Cantor's First Paradox,name=Cantor Paradox I]
  $\Card$ is not a set.
\end{theorem}
\begin{proof}[forthel]
...
\begin{theorem}[forthel,title=Cantor's Second Paradox,name=Cantor Paradox II]
  $\Set$ is not a set.
\end{theorem}
\begin{proof}[forthel]
  Assume the contrary.
